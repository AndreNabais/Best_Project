...
void triggerMetroHigh() { metroHighActive = true; metroSampleCount = 0; }
void triggerMetroLow()  { metroLowActive = true;  metroSampleCount = 0; }
...
bool metroHighActive, metroLowActive;
uint32_t metroSampleCount;
};
